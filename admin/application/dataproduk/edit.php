    ...
    ?>
      <form action="index.php?p=dataproduk/proses_edit.php&id=<?php echo $id_bahan; ?>" method="post">
          ...
          <div class="form-group">
              ...
              <input id="nama_bahan"  type="text" value="<?php echo $data['nama_bahan']; ?>" readonly class="form-control">
          </div>
          <div class="form-group">
              <label for="harga_bahan" >Harga Bahan</label>
              <input id="harga_bahan" name="harga_bahan" type="text" value="<?php echo $data['harga_bahan']; ?>" class="form-control">
          </div>
